...
# 关键：设置Qt使用offscreen插件
os.environ['QT_QPA_PLATFORM'] = 'offscreen'
os.environ['ETS_TOOLKIT'] = 'qt4'

print("Environment variables set:")
print(f"  HOME={os.environ['HOME']}")
print(f"  QT_QPA_PLATFORM={os.environ['QT_QPA_PLATFORM']}")

# 使用pyvirtualdisplay (官方visualization/visualize_utils.py的方式)
from pyvirtualdisplay import Display
display = Display(visible=False, size=(2560, 1440))
display.start()
print("pyvirtualdisplay started")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scene-idx', nargs='+', type=int, default=[0, 1])
